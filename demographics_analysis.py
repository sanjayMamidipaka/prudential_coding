...
age_vals, columns = ranking_object.two_sort_ascending(list(data.loc['Ages 18-29']), list(data.columns))
...
age_vals, columns = ranking_object.two_sort_ascending(list(data.loc['30-49']), list(data.columns))
