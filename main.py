...
percents2 = [len(data[data['device1b'] == 1])/len(data), len(data[data['device1c'] == 1])/len(data), len(data[data['device1d'] == 1])/len(data)]
#x axis labels
labels2 = ['Tablet','Desktop/Laptop','Game Console']
#sets the size of the graph
plt.figure(figsize=(16,6))
#graph, with the x axis labels and y values
